...
/**
 * `MapPickerDialog` cho Place — bọc `LocationMap` (đã có sẵn ở
 * `components/settings/location-map.tsx`, KHÔNG viết lại bản đồ), cùng
 * cách `components/drink/map-picker-dialog.tsx` làm cho Cafe. Xây file
 * riêng cho Place theo đúng phương án B đã chốt (không generic hoá,
 * không import chéo qua thư mục drink) — Phase 4.
 */
  ...
  return (
    ...
    >
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Vị trí địa điểm</DialogTitle>
